    ...
    return (
        <div className='fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around ' >
            ...
            <button
                ...
                onClick = {openModal}
                className = " absolute bottom-6 bg-[#F6B100] text-[#5f5f5f] rounded-full p-3 items-center justify-center ">
                    <BiSolidDish size={30} />
            </button>
            <Modal isOpen={isModalOpen}  onClose = {closeModal} title = "CreateOrder">
                <div>
                ...
                <div>
                    ...
                    <div className = "flex items-center rounded-lg p-3 px-4 bg-[#1f1f1f]">
                        <input  value = {phone} onChange = {(e) => setPhone(e.target.value)} type="number" name="" placeholder="+1" id=""
                            className = "bg-transparent flex-1 text-white focus:outline-none" />

                    </div>
                </div>
                <div>
                    <label className="block mb-2 mt-2 text-sm font-medium text-[#ababab]">Guest</label>
                    ...
                    <button onClick = {() => 
                        handleCreateOrder()
                        } className="w-full bg-[#f68100] text-[#f5f5f5] rounded-lg py-3 mt-4 hover:bg-yellow-700">
                        Create Order
                    </button>
                </div>
