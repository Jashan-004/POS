...
const OrderCard = () => {
    return (<div className='w-[500px] bg-[#262626] p-4 rounded-lg mb-4'>
                    <div className = "flex items-center gap-5">
                        <button className ='bg-[#f6b100] p-3 text-xl font-bold rounded-lg '>AM</button>
                        <div className="flex items-center justify-between w-[100%] "> 

                        <div className="flex flex-col items-start gap-1">
                            <h1 className='text-[#f5f5f5] text-lg font-semibold tracking-w-[100%] '> JashanSidhu</h1>
                            <p className='text-[#ababab]'>#101 Dine In</p>
                        </div>
